...
class ContainerVC: UIViewController {
    ...
    var isHidden = false
    //slides in to this X coordinate
    ...
    func initCenter(screen: ShowWichVC) {
        ...
        var presentingContoller: UIViewController
        ...
        centerController = presentingContoller
